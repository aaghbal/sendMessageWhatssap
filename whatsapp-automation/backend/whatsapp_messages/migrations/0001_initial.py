    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.CharField(choices=[('text', 'Text Only'), ('media', 'With Media'), ('location', 'With Location')], default='text', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_used', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='whatsapp_messages.messagetemplate')),
